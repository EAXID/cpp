...
int main(int argc, char** argv) 
{
	...
	student s("2031053231","张三","123456",'1',"陕西",2020,9,23,2002,9,2,"M",c1,c2,c3);
    Date b1(2002,9,2);
	course c11("Chinese","C001",5,85,2.0);
	course c21("Math","C002",5,85,2.0);
	course c31("English","C003",5,85,2.0);
	student s1("2031053231","李四","123456",'1',"陕西",2020,9,23,2001,9,2,"M",c11,c21,c31);
	Date b2(2001,9,2);
